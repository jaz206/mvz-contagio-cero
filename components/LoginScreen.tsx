...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onGoogleLogin, onEditorLogin, language, setLanguage }) => {
  ...
  return (
    <div className="absolute inset-0 z-50 bg-slate-950 flex flex-col items-center justify-center font-mono text-cyan-400 overflow-hidden">
      ...
      {/* MAIN CONTAINER */}
      <div className="relative z-10 flex flex-col items-center w-full max-w-md p-10 border border-cyan-900/50 bg-slate-900/80 backdrop-blur-md shadow-[0_0_100px_rgba(6,182,212,0.15)] clip-tactical">
