...
// --- MAIN COMPONENT: BUNKER INTERIOR ---
export const BunkerInterior: React.FC<BunkerInteriorProps> = ({
    ...
    return (
        <div className="w-full h-full bg-slate-950 font-mono relative overflow-hidden select-none">
            ...
            {/* CAPA 1: BUNKER BLUEPRINT SVG BACKGROUND (z-0) */}
            <div className="absolute inset-0 z-0 pointer-events-auto">
                <BunkerMapSVG 
                    onBack={onBack} 
                    onOpenDatabase={() => { setIsEditingExisting(false); setShowRecruitModal(true); }}
                />
            </div>

            {/* CAPA 2: HERO TOKENS LAYER (z-10) */}
            ...
            {/* CAPA 3: HERO DETAIL MODAL (Overlay) (z-60) */}
