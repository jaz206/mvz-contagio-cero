...
export const NewsTicker: React.FC<NewsTickerProps> = ({ alignment, worldStage, urgentMessage }) => {
    ...
    // CAMBIO AQUÍ: Eliminado 'fixed bottom-0 left-0 right-0' y añadido 'w-full flex-none relative'
    return (
        <div className={`w-full flex-none relative h-8 ${colorClass} border-t flex items-center overflow-hidden z-50 select-none shadow-[0_-5px_20px_rgba(0,0,0,0.5)] transition-all duration-500`}>
