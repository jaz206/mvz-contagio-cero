...
const GameContent: React.FC = () => {
    ...
    return (
        <Routes>
            ...
            <Route path="/intro" element={playerAlignment ? <IntroSequence language={lang} playerAlignment={playerAlignment} onComplete={() => { actions.setIsStartingCampaign(false); if (state.introMission && !hasCompletedIntroMission) { navigate('/mission0'); } else if (!hasSeenTutorial) { navigate('/tutorial'); } else { navigate('/map'); } }} /> : <Navigate to="/" />} />
