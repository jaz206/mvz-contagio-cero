...
export const translations = {
    es: {
        header: {
            ...
            logout: "SALIR",
            ticker: {
                scanning: "[ESCANEANDO FRECUENCIAS DE EMERGENCIA...]",
                intel: "[RECUPERANDO INTEL DE S.H.I.E.L.D....]",
                threat: "[ALERTA: NIVEL DE AMENAZA EN AUMENTO]",
                survivors: "[SEÑALES DE VIDA DETECTADAS EN SECTOR 4]",
                hulk: "[ADVERTENCIA: RADIACIÓN GAMMA DETECTADA EN KANSAS]",
                galactus: "[EL CIELO SE VUELVE PÚRPURA... EL FIN SE ACERCA]"
            }
        },
        sidebar: {
        ...
        login: {
            ...
            localBtn: "MODO LOCAL",
            scanHelp: "ENTRA CON TU CUENTA. SI ERES ADMIN O EDITOR, LA APP LO RECONOCE SOLA.",
            localHelp: "ACCESO LOCAL SIN CUENTA. NO GUARDA PROGRESO.",
            accessUnavailable: "ACCESO CON CUENTA NO DISPONIBLE",
    ...
    en: {
        header: {
            ...
            logout: "LOGOUT",
            ticker: {
                scanning: "[SCANNING EMERGENCY FREQUENCIES...]",
                intel: "[RETRIEVING S.H.I.E.L.D. INTEL...]",
                threat: "[ALERT: THREAT LEVEL INCREASING]",
                survivors: "[LIFE SIGNALS DETECTED IN SECTOR 4]",
                hulk: "[WARNING: GAMMA RADIATION DETECTED IN KANSAS]",
                galactus: "[THE SKY TURNS PURPLE... THE END IS NEAR]"
            }
        },
        sidebar: {
        ...
        login: {
            ...
            localBtn: "LOCAL MODE",
            scanHelp: "SIGN IN WITH YOUR ACCOUNT. ADMIN AND EDITOR ACCESS ARE DETECTED AUTOMATICALLY.",
            localHelp: "LOCAL ACCESS WITHOUT ACCOUNT. PROGRESS IS NOT SAVED.",
            accessUnavailable: "ACCOUNT ACCESS NOT AVAILABLE",
